...
import frizp from "../images/frizp-high-resolution-logo-transparent.png";
...
const Header = () => {
    ...
    return (
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white border-b shadow-md">
            {loading && <Loader />}
            ...
            <div className="flex h-5 items-center">
                ...
                <Link to="/" className="flex h-8 items-center">
                    <img
                        className="h-full dark:lg:block"
                        src={frizp}
                        alt="FRIZP"
                    />
                    <img
